...
(function (DragDropApp) {
    ...
    var ProjectState = /** @class */ (function (_super) {
        ...
        ProjectState.prototype.addProject = function (title, description, people) {
            var newProject = new DragDropApp.Project(Math.random().toString(), title, description, people, DragDropApp.ProjectStatus.ACTIVE);
    ...
    var ProjectList = /** @class */ (function (_super) {
        ...
        ProjectList.prototype.filterProjectsByStatus = function (projects) {
            ...
            return projects.filter(function (item) {
                ...
                switch (_this.type) {
                    case "active":
                        result = item.status === DragDropApp.ProjectStatus.ACTIVE;
                        break;
                    case "finished":
                        result = item.status === DragDropApp.ProjectStatus.FINISHED;
                        break;
                    default:
                        result = false;
                }
        ...
        ProjectList.prototype.dropHandler = function (event) {
            ...
            var projectStatus = this.type === 'active' ?
                DragDropApp.ProjectStatus.ACTIVE :
                DragDropApp.ProjectStatus.FINISHED;
